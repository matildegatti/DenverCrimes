...
public class FXMLController {
    ...
    void doCalcolaPercorso(ActionEvent event) {
    	...
    	List<String> percorso = (List<String>) this.model.trovaPercorso(arco.getV1(), arco.getV2());
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	LinkedList<Adiacenza> archi = new LinkedList<Adiacenza>(this.model.getArchi());
